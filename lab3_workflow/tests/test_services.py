...
from lab3_workflow.proposal.service import RuleBasedProposalService
from lab3_workflow.sizing.service import estimate_ai_requirements
from lab3_workflow.validation.service import validate_configuration
